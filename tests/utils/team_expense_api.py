...
def deterministic_hash(s: str) -> int:
    """Generate a deterministic hash value that is consistent across Python processes."""
...
def get_expenses(employee_id: str, quarter: str) -> str:
    ...
    # Use deterministic_hash instead of hash() to ensure consistency across Python processes
    if RANDOM_SEED is not None:
        random.seed(RANDOM_SEED + deterministic_hash(employee_id + quarter))
    else:
        random.seed(deterministic_hash(employee_id + quarter))
